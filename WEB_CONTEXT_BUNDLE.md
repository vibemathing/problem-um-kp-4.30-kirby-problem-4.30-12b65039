...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.30-kirby-problem-4.30-12b65039-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.30"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.30-kirby-problem-4.30-12b65039-v1",
      "problem_contract_sha256": "b5eff6fcf022f67daa79cf309b43a482c263004aa7399c78b021ed7cc9f95d44",
      "problem_id": "problem:um-kp-4.30-kirby-problem-4.30-12b65039",
      "route_id": "route:um-kp-4.30-kirby-problem-4.30-12b65039-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.30-kirby-problem-4.30-12b65039-source-fidelity-01",
      "graph_id": "graph:um-kp-4.30-kirby-problem-4.30-12b65039-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.30-kirby-problem-4.30-12b65039-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.30-kirby-problem-4.30-12b65039-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does there exist a pair of closed, oriented surfaces in $S^{4}$ that are topologically but not smoothly isotopic? If such an exotic pair exists, does there exist an infinite family? Can the surfaces be taken to be 2-spheres? Surfaces of genus-g for any given $g \\geq$ 0?"
          },
          "statement_sha256": "c3309fde5ca45c356ed197f17c3b06a19a3c6ecafd7eb1e5d4de858e8d811154"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.30-kirby-problem-4.30-12b65039-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.30-kirby-problem-4.30-12b65039-root",
      "route_id": "route:um-kp-4.30-kirby-problem-4.30-12b65039-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.30-92ab4854cee8",
        "url": "https://www.unsolvedmath.com/problems/KP-4.30"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
